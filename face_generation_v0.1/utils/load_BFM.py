...
#     """
#     加载表情分量模型
#     :param bfm_folder: 放置所有BFM模型文件的文件夹
#     :return: expPC, expEV
#     """
#     n_vertex = 53215
...
#     shapePC = original_BFM['shapePC']  # shape basis                  形状PCA降维矩阵
#     shapeEV = original_BFM['shapeEV']  # corresponding eigen value    形状正交空间的系数
#     shapeMU = original_BFM['shapeMU']  # mean face                    形状平均向量
#     texPC = original_BFM['texPC']  # texture basis                    纹理PCA降维矩阵
#     texEV = original_BFM['texEV']  # eigen value                      纹理正交空间的系数
#     texMU = original_BFM['texMU']  # mean texture                     纹理平均向量
#
#     expPC, expEV = LoadExpBasis()     # 加载表情模型，expPC为表情PCA降维矩阵，expEV为表情系数
#
